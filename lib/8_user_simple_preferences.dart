...
class UserSimplePreferences {
  ...
  //POMODORO FUNCTIONS __________________________________________
           //FUNCTION: setting the pomodoro score value to the sharedpref
  static Future<void> setPomodoroScore1(int pomodoroScore1) async {
    await _preferences.setInt(_keyPomodoroScore1, pomodoroScore1);
  }
      //everytime a pomodoro timer finishes (in an if statement), the score should be incremented by 10,000

            //FUNCTION: getting/accessing the pomodoro score value, to be diplayed on the UI
  ...
  //SETTING PIE CHART FUNCTIONS _____________________________________________
    //this will be for identifying which chart is on play
  ...
  //STATS PAGE-RELATED FUNCTIONS ___________________________________________________
  //---------------quiz accuracy rate and net rate
  ...
  //   _preferences.remove(_keyPomodoroScore1);
  // }
  }
